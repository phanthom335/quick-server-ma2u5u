    ...
    Quick Server Ma2u5u
    ===================
    A fast CLI utility to audit files and directories straight from the terminal.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to audit files and directories straight from the terminal.")
